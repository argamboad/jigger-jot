...
namespace JiggerJot.Api.Tests.PublicApi;
...
public class ApiKeyServiceTests(PostgresFixture fixture) : PostgresTestBase(fixture)
{
    ...
    private static ApiKeyService Build(JiggerJot.Infrastructure.Persistence.AppDbContext db, TimeProvider? clock = null) =>
