...
{
    private const string Issuer = "JiggerJot"; // rebrandable — appears in the authenticator app
    ...
    // encrypted at rest undecryptable. Kept through the JiggerJot rename; bump only with a re-encrypt migration.
