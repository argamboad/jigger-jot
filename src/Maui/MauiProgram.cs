...
public static class MauiProgram
{
	...
	//  - Android uses http://localhost:5438 via `adb reverse tcp:5438 tcp:5438`, which maps
	...
	//    so the provider redirect_uri http://localhost:5438/signin-google is valid (and is
	...
	// its code (found in y-el-vuelto, 2026-09-14, Windows + Android against staging; platform PR #230).
