...
namespace JiggerJot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260909234520_RecipeSourceAndOptionalGlassMethod")]
    partial class RecipeSourceAndOptionalGlassMethod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.ApiKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.Cocktail", b =>
                {
                    ...
                    b.HasIndex("ForkedFromCocktailId");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.CocktailIngredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CocktailId", "IsRequired");

                    b.ToTable("CocktailIngredients");
                });

            modelBuilder.Entity("JiggerJot.Core.Entities.GlassType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.IngredientCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.IngredientSubstitution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("IngredientId", "SubstituteIngredientId")
                        .IsUnique();
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.Method", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.MfaRecoveryCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.RecipeSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.TenantInventory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.Unit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<decimal?>("MillilitreFactor")
                        .HasPrecision(12, 6)
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.UsageCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.UserMfa", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.WebhookSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.Cocktail", b =>
                {
                    ...
                    b.HasOne("JiggerJot.Core.Entities.RecipeSource", "Source")
                        .WithMany()
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.CocktailIngredient", b =>
                {
                    b.HasOne("JiggerJot.Core.Entities.Cocktail", "Cocktail")
                        .WithMany("Lines")
                        .HasForeignKey("CocktailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JiggerJot.Core.Entities.Ingredient", "Ingredient")
                        .WithMany()
                        .HasForeignKey("IngredientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("JiggerJot.Core.Entities.Unit", "Unit")
                        .WithMany()
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.Ingredient", b =>
                {
                    b.HasOne("JiggerJot.Core.Entities.IngredientCategory", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("JiggerJot.Core.Entities.IngredientCategory", "Subcategory")
                        .WithMany()
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.IngredientCategory", b =>
                {
                    b.HasOne("JiggerJot.Core.Entities.IngredientCategory", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("JiggerJot.Core.Entities.IngredientSubstitution", b =>
                {
                    ...
                    b.HasOne("JiggerJot.Core.Entities.Ingredient", "SubstituteIngredient")
                        .WithMany()
