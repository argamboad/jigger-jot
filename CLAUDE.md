...
| `docs/PLAN.md` | **Read first, every session** — the three gates, the slice ritual, the editing rules, where things stand, and the sequenced backlog (every feature flow shipped; next is the `BACKBAR` restyle ladder, 1 → 7) |
